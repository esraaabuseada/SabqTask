...
extension UIViewController {
    ...
    static func loadViewControllerFromXib<Controller: UIViewController>() -> Controller {
        ...
        let cellNib = UINib(nibName: String(describing: self), bundle: Bundle.main)
        guard let controller =  cellNib.instantiate(withOwner: nil, options: nil).first as? Controller else {
